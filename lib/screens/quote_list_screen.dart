...
class _QuoteListScreenState extends State<QuoteListScreen> {
  ...
  // ★★★★ ДОБАВЛЕННЫЙ МЕТОД ДЛЯ ТЕСТИРОВАНИЯ ★★★★
  void _showSimpleTestDialog() {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: const Text('Тестирование приложения'),
        content: SingleChildScrollView(
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              ...
              const SizedBox(height: 8),
              const Text(
                'Все основные функции готовы к использованию!',
                textAlign: TextAlign.center,
              ),
              const SizedBox(height: 24),
              const Divider(),
              ...
              const SizedBox(height: 8),
              _TestItem(text: '✅ Создание и редактирование КП'),
              _TestItem(text: '✅ 22 шаблона позиций'),
              _TestItem(text: '✅ PDF генерация и шаринг'),
              _TestItem(text: '✅ Настройки компании'),
              _TestItem(text: '✅ Локальная база данных'),
              _TestItem(text: '✅ Навигация и меню'),
            ],
          ),
        ),
        actions: [
  ...
  Future<void> _createTestData() async {
    try {
      ...
      final testQuote = Quote(
        ...
        clientAddress: 'г. Москва, тестовая улица, д. 1',
        notes: 'Это тестовое коммерческое предложение',
        totalAmount: 18500.0,
        ...
        items: [
          ...
          LineItem(
            quoteId: 0,
            name: 'Монтаж закладных под световое оборудование',
      ...
      await _dbHelper.insertQuote(testQuote);
      
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Тестовые данные созданы успешно!'),
          backgroundColor: Colors.green,
